...
If live: help them script the exact click path for the demo — what to show, in what order.
If recorded: suggest what to capture and how to keep it under 60–90 seconds.
...
- **Always know the deadline.** If the user hasn't mentioned it, ask. Factor it into every recommendation.
